    ...
    <div className="relative flex bg-white pt-8">
      ...
      <div>
        <Image
          ...
          alt="Telur Balado Pedas Cabe Hijau"
          width={200}
          height={150}
          className="mb-4"
        />
        ...
        <div>
          ...
          <ul className="ml-8 mr-24 list-disc text-left">
            ...
            <li>5 butir bawang merah tumbuk kasar</li>
            <li>10 buah cabai hijau besar atau berukuran kira-kira 150 gr tumbuk kasar</li>
            <li>5 buah cabai hijau keriting segar tumbuk kasar</li>
          </ul>
        </div>
        <div>
          <br />
          ...
          <ul className="ml-8 mr-24 list-disc text-left">
            <li>
              Tumis bawang merah, cabai hijau besar, cabai hijau keriting, serai, dan daun salam
              hingga tercium harum.
            </li>
        ...
        <div className="bottom-0 right-0 mb-2 mr-2 flex items-center justify-end space-x-2">
          <button
            type="button"
